...
location in `/code/app/plugin/{type}` of the YAC container. Each plugin type
is a bit different in it's handling, see the according `README.md` for details
and the existing plugins source code as examples:
